...
import com.clauto.recyclerview.ktx.R
...
@Deprecated(
    ...
    ReplaceWith("addEdgeSpacing", "com.clauto.recyclerview")
)
...
fun RecyclerView.fixEdgeEffect(overScrollIfContentScrolls: Boolean = true, alwaysClipToPadding: Boolean = true) {
    if (overScrollIfContentScrolls) {
        ...
        setTag(R.id.tag_clauto_recyclerView_OverScrollIfContentScrollsListener, listener)
    } else {
        val listener =
            getTag(R.id.tag_clauto_recyclerView_OverScrollIfContentScrollsListener) as? OverScrollIfContentScrollsListener
        if (listener != null) {
            removeOnLayoutChangeListener(listener)
            setTag(R.id.tag_clauto_recyclerView_OverScrollIfContentScrollsListener, null)
        }
    }
