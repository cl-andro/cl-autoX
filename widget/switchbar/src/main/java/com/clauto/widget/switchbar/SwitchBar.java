package com.clauto.widget.switchbar;
...
public class SwitchBar extends LinearLayout implements Checkable {
    ...
    private static final String KEY_SUPER_STATES = "com.clauto.widget.switchbar.superStates";
    private static final String KEY_IS_CHECKED = "com.clauto.widget.switchbar.isChecked";
