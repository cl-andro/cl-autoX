...
![Maven Central](https://img.shields.io/maven-central/v/com.clauto.cl.lazy/lazy)
...
```groovy
dependencies {
    implementation "com.clauto.cl.lazy:lazy:<version>"
}
```
...
This library has a `com.clauto.lazy.Lazy` interface and all implementations are its subclass.

There two implementation, `com.clauto.lazy.SynchronizedLazy` (thread-safe version using locks inside) and `com.clauto.lazy.UnsafeLazy` (no thread-safe version).
